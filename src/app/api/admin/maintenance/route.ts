// POST /api/admin/maintenance { task: "purge-deleted" | "sweep-uploads" | "reconcile" | "expire-anonymous" | "backfill-text", dryRun? }
...
const body = z.object({ task: z.enum(["purge-deleted", "sweep-uploads", "reconcile", "expire-anonymous", "backfill-text"]), dryRun: z.boolean().optional() });
