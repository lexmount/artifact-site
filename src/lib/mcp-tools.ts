...
export const mcpTools = [
  ...
  ["artifact_site_move", "Move to folder"],
  ...
  ["artifact_site_comments_list", "List comments"],
  ["artifact_site_comment_read", "Read a discussion"],
  ["artifact_site_comment_image", "Read comment image"],
  ["artifact_site_comment_result", "Link a comment result"],
  ["artifact_site_comment_context", "Read comment context"],
