...
**Ein selbst gehosteter Ort für die KI-generierten Seiten und Dokumente Ihres Teams.** Veröffentlichen Sie HTML, Build-Ordner, ZIPs und PDFs als versionierte Links mit Sandbox-Isolation. Agenten können über die CLI oder Remote-MCP veröffentlichen, aktualisieren, suchen und lesen.
